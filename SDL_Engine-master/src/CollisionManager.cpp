...
bool CollisionManager::lineAngledRectCheck(glm::vec2 line1_start, glm::vec2 line1_end, glm::vec2 rect_centre, float rect_width, float rect_height, float angle)
{
	//glm::vec2 rect_lt = { rect_centre.x - rect_width * 0.5f, rect_centre.y - rect_height };
	//glm::vec2 rect_lb = { rect_centre.x - rect_width * 0.5f, rect_centre.y + rect_height };
	//glm::vec2 rect_rt = { rect_centre.x + rect_width * 0.5f, rect_centre.y - rect_height };
	//glm::vec2 rect_rb = { rect_centre.x + rect_width * 0.5f, rect_centre.y + rect_height };
	//glm::vec2 rect_tl = { rect_centre.x - rect_width * 0.5f, rect_centre.y - rect_height };
	//glm::vec2 rect_tr = { rect_centre.x + rect_width * 0.5f, rect_centre.y - rect_height };
	//glm::vec2 rect_bl = { rect_centre.x - rect_width * 0.5f, rect_centre.y + rect_height };
	//glm::vec2 rect_br = { rect_centre.x + rect_width * 0.5f, rect_centre.y + rect_height };
	glm::vec2 rect_lt = { - rect_width * 0.5f, - rect_height };
	glm::vec2 rect_lb = { - rect_width * 0.5f, + rect_height };
	glm::vec2 rect_rt = { + rect_width * 0.5f, - rect_height };
	glm::vec2 rect_rb = { + rect_width * 0.5f, + rect_height };
	glm::vec2 rect_tl = { - rect_width * 0.5f, - rect_height };
	glm::vec2 rect_tr = { + rect_width * 0.5f, - rect_height };
	glm::vec2 rect_bl = { - rect_width * 0.5f, + rect_height };
	glm::vec2 rect_br = { + rect_width * 0.5f, + rect_height };
	rect_lt = Util::rotate(rect_lt, angle);
	rect_lb = Util::rotate(rect_lb, angle);
	rect_rt = Util::rotate(rect_rt, angle);
	rect_rb = Util::rotate(rect_rb, angle);
	rect_tl = Util::rotate(rect_tl, angle);
	rect_tr = Util::rotate(rect_tr, angle);
	rect_bl = Util::rotate(rect_bl, angle);
	rect_br = Util::rotate(rect_br, angle);
	rect_lt += rect_centre;
	rect_lb += rect_centre;
	rect_rt += rect_centre;
	rect_rb += rect_centre;
	...
	const auto l = lineLineCheck(line1_start, line1_end, rect_lt, rect_lb);
	const auto r = lineLineCheck(line1_start, line1_end, rect_rt, rect_rb);
	const auto t = lineLineCheck(line1_start, line1_end, rect_tl, rect_tr);
	const auto b = lineLineCheck(line1_start, line1_end, rect_bl, rect_br);
