...
public:
	...
	// drawing functions
	void draw(const std::string& id, int x, int y, double angle = 0, int alpha = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE, float scalex = 1.0f, float scaley = 1.0f);
